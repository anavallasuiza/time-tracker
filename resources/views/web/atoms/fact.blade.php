<tr data-id="<?php echo $fact->id; ?>" data-remote="<?php echo $fact->remote_id; ?>" class="row-fact">
    ...
    <?php endif;?>
    <td class="text-center column-start"><?php echo $fact->start_time->format($user->getDateFormatConfig()); ?></td>
    <td class="text-center column-end"><?php echo $fact->end_time->format($user->getDateFormatConfig()); ?></td>
    ...
    <td class="text-right column-time">
        ...
        <div class="col-xs-4 column-actions">
            <?php if ($user->isAdmin() || ($user->id === $fact->users->id)) { ?>
