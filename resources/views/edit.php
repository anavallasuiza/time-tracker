<div class="row">
    <div class="col-xs-6">
        ...
        <div class="list-group">
            ...
            <a href="<?php echo url('activity', $activity->id); ?>" class="list-group-item">
        ...
        <a href="<?php echo url('activity'); ?>" class="btn btn-success btn-block"><?php echo _('Add new activity'); ?></a>
    </div>
    ...
    <div class="col-xs-6">
        ...
        <div class="list-group">
            ...
            <a href="<?php echo url('tag', $tag->id); ?>" class="list-group-item"><?php echo $tag->name; ?></a>
            <?php } ?>
        </div>

        <a href="<?php echo url('tag'); ?>" class="btn btn-success btn-block"><?php echo _('Add new tag'); ?></a>
    </div>
    ...
    <div class="col-xs-6 mt-20">
        ...
        <div class="list-group">
            ...
            <a href="<?php echo url('user', $user->id); ?>" class="list-group-item">
                <?php echo $user->name; ?>
        ...
        <a href="<?php echo url('user'); ?>" class="btn btn-success btn-block"><?php echo _('Add new user'); ?></a>
    </div>
    <?php } ?>
    ...
    <?php if ($clients) { ?>
        <div class="col-xs-6 mt-20">
            ...
            <ul class="list-group">
                <?php foreach ($clients as $client) { ?>
                    <li class="list-group-item">
                        <a href="<?php echo url(route('client.edit', ['id' => $client->id])); ?>" class="text-black">
            ...
            <a href="<?php echo url(route('client.add')); ?>" class="btn btn-success btn-block"><?php echo _('Add new client'); ?></a>
        </div>
    <?php } ?>
</div>
