<form method="post">
    ...
    <h1><?php echo sprintf(_('Activity %s'), $activity->name); ?></h1>
    <div class="alert alert-warning">
        <?php echo sprintf(_('Take care %s this activity. There are users using automated tools based in Basecamp projects names. Name used to this activity must be exactly as Basecamp project name or duplicated projects will be created.'), empty($activity->id) ? 'creating' : 'editing'); ?>
    </div>
    ...
    <div class="form-group text-center">
        ...
        <button type="submit" name="action" value="activity<?php echo empty($activity->id) ? 'Add' : 'Edit'; ?>" class="btn btn-success">
